    ...
    for episode in tqdm(range(1, EPISODES + 1), ascii=True, unit='episodes'):
        ...
        while True:
            ...
            if np.random.random() > epsilon:
                ...
                # action = np.random.choice([0, 1, 2], p=[0.0, 0.5, 0.5])
        ...
        if not episode % AGGREGATE_STATS_EVERY or episode == 1:
            ...
            if min_reward >= MIN_REWARD:
                ...
                # Try clearing the session here after saving a model
                # TODO Validate that this fixes the memory leak
                # UPDATE - it does not fix the memory leak and can occasionally cause a crash... :(
